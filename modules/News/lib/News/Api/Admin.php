...
class News_Api_Admin extends Zikula_AbstractApi
{
    ...
    public function update($args)
    {
        ...
        // clear lists cache if new or old article have published status only
        $args['clearlistscache'] = (isset($args['published_status']) && $args['published_status'] == 0) || (isset($item['published_status']) && $item['published_status'] == 0);
        ModUtil::apiFunc('News', 'user', 'clearItemCache', $args);
