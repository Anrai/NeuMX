...
{if $enablecategorization}
    ...
    <br /><h3>{$NewsCatTitle}</h3>

    {foreach from=$propertiesdata item='property'}
        {if $propertiesdata|@count gt 1}
        <br /><h4>
        {array_field assign='propertyname' array=$property.category.display_name field=$lang}
        {if $propertyname eq ''}{assign var='propertyname' value=$property.category.name}{/if}
        {$propertyname}
